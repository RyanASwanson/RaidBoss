...
/// Description: Material editor of the shader Flat Lighting/Six Colors Blend.
///
...
/// \english
/// <summary>
/// Material editor of the shader Flat Lighting/Six Colors Blend.
/// </summary>
/// \endenglish
/// \spanish
/// <summary>
/// Editor del material del shader Flat Lighting/Six Colors Blend.
/// </summary>
/// \endspanish
[CanEditMultipleObjects]
public class CGFFlatLightingSixColorsBlendMaterialEditor : CGFMaterialEditorClass
{
    ...
    protected override void InspectorGUI()
    {
        ...
        CGFMaterialEditorUtilitiesClass.BuildMaterialComponent(typeof(CGFFlatLightingSixColorsBlendBehavior));
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Front Color (RGBA)", "Color of the front normals.", _FrontColor);
        CGFMaterialEditorUtilitiesClass.BuildColor("Right Color (RGBA)", "Color of the right normals.", _RightColor);
        CGFMaterialEditorUtilitiesClass.BuildColor("Top Color (RGBA)", "Color of the top normals.", _TopColor);
        CGFMaterialEditorUtilitiesClass.BuildColor("Back Color (RGBA)", "Color of the back normals.", _BackColor);
        CGFMaterialEditorUtilitiesClass.BuildColor("Left Color (RGBA)", "Color of the left normals.", _LeftColor);
        CGFMaterialEditorUtilitiesClass.BuildColor("Bottom Color (RGBA)", "Color of the bottom normals.", _BottomColor);
        GUILayout.Space(10);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Front Top Color (RGBA)", "Color of the top part of the gradient.", _FrontTopColor, _FrontGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Right Top Color (RGBA)", "Color of the top part of the gradient.", _RightTopColor, _RightGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Top Top Color (RGBA)", "Color of the top part of the gradient.", _TopTopColor, _TopGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Back Top Color (RGBA)", "Color of the top part of the gradient.", _BackTopColor, _BackGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Left Top Color (RGBA)", "Color of the top part of the gradient.", _LeftTopColor, _LeftGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Bottom Top Color (RGBA)", "Color of the top part of the gradient.", _BottomTopColor, _BottomGradient.floatValue);
        ...
        CGFMaterialEditorUtilitiesClass.BuildFloat("Bottom Gradient Width", "Gradient width.", _BottomGradientWidth, _BottomGradient.floatValue);
        ...
        GUILayout.Space(10);
        CGFMaterialEditorUtilitiesClass.BuildSlider("Opacity level", "Overall opacity value.", _OpacityLevel);
        GUILayout.Space(10);
