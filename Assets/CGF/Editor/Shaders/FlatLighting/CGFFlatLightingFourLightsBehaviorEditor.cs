...
/// Description: Editor of the behavior of material of the shader CG Framework/Flat Lighting/Four Lights.
///
...
namespace CGF.Editor.Shaders.FlatLighting
{
    ...
    /// \english
    /// <summary>
    /// Editor of the behavior of material of the shader CG Framework/Flat Lighting/Four Lights.
    /// </summary>
    /// \endenglish
    /// \spanish
    /// <summary>
    /// Editor del comportamiento del material del shader CG Framework/Flat Lighting/Four Lights.
    /// </summary>
    /// \endspanish
    [CustomEditor(typeof(CGFFlatLightingFourLightsBehavior))]
    [CanEditMultipleObjects]
    public class CGFFlatLightingFourLightsBehaviorEditor : CGFFlatLightingFourLightsBaseEditor<CGFFlatLightingFourLightsBehavior>
    {
