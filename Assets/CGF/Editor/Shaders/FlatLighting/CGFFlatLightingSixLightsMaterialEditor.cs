...
/// Description: Material editor of the shader Flat Lighting/Six Lights.
///
...
/// \english
/// <summary>
/// Material editor of the shader Flat Lighting/Six Lights.
/// </summary>
/// \endenglish
/// \spanish
/// <summary>
/// Editor del material del shader Flat Lighting/Six Lights.
/// </summary>
/// \endspanish
[CanEditMultipleObjects]
public class CGFFlatLightingSixLightsMaterialEditor : CGFMaterialEditorClass
{
    ...
    protected override void InspectorGUI()
    {
        ...
        CGFMaterialEditorUtilitiesClass.BuildMaterialComponent(typeof(CGFFlatLightingSixLightsBehavior));
        ...
        CGFMaterialEditorUtilitiesClass.BuildSlider("Back Opacity Level", "Opacity of the color of the back normals.", _BackOpacityLevel, useAlpha);
        CGFMaterialEditorUtilitiesClass.BuildSlider("Left Opacity Level", "Opacity of the color of the left normals.", _LeftOpacityLevel, useAlpha);
        CGFMaterialEditorUtilitiesClass.BuildSlider("Bottom Opacity Level", "Opacity of the color of the bottom normals.", _BottomOpacityLevel, useAlpha);
        GUILayout.Space(10);
