...
/// Description: Material editor of the shader Flat Lighting/Four Lights Blend.
///
...
/// \english
/// <summary>
/// Material editor of the shader Flat Lighting/Four Lights Blend.
/// </summary>
/// \endenglish
/// \spanish
/// <summary>
/// Editor del material del shader Flat Lighting/Four Lights Blend.
/// </summary>
/// \endspanish
[CanEditMultipleObjects]
public class CGFFlatLightingFourLightsBlendMaterialEditor : CGFMaterialEditorClass
{
    ...
    protected override void InspectorGUI()
    {
        ...
        CGFMaterialEditorUtilitiesClass.BuildMaterialComponent(typeof(CGFFlatLightingFourLightsBlendBehavior));
        ...
        CGFMaterialEditorUtilitiesClass.BuildSlider("Rim Opacity Level", "Opacity of the color of the rim normals.", _RimOpacityLevel);
        GUILayout.Space(10);
