...
/// Description: Material editor of the shader Flat Lighting/Four Colors Blend.
///
...
/// \english
/// <summary>
/// Material editor of the shader Flat Lighting/Four Colors Blend.
/// </summary>
/// \endenglish
/// \spanish
/// <summary>
/// Editor del material del shader Flat Lighting/Four Colors Blend.
/// </summary>
/// \endspanish
[CanEditMultipleObjects]
public class CGFFlatLightingFourColorsBlendMaterialEditor : CGFMaterialEditorClass
{
    ...
    {
        CGFMaterialEditorUtilitiesClass.BuildMaterialComponent(typeof(CGFFlatLightingFourColorsBlendBehavior));
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Rim Color (RGBA)", "Color of the rim normals.", _RimColor);
        GUILayout.Space(10);
        ...
        CGFMaterialEditorUtilitiesClass.BuildTexture("Rim Texture (RGBA)", "Texture of the rim normals.", _RimTexture, this, true, _compactMode);
        ...
        CGFMaterialEditorUtilitiesClass.BuildColor("Rim Top Color (RGBA)", "Color of the top part of the gradient.", _RimTopColor, _RimGradient.floatValue);
