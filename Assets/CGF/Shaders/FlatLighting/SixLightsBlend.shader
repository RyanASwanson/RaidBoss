...
/// Description: Flat Lighting/Six Lights Blend shader that applies six lights based on the normals of the mesh with a blend mode.
///
...
Shader "CG Framework/Flat Lighting/Six Lights Blend"
{
	Properties
	{
	...
	Fallback "Diffuse"
	CustomEditor "CGFFlatLightingSixLightsBlendMaterialEditor"
